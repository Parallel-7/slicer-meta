...
> **Source**: [https://docs.github.com/en/actions/tutorials/create-actions/create-a-composite-action](https://docs.github.com/en/actions/tutorials/create-actions/create-a-composite-action)
